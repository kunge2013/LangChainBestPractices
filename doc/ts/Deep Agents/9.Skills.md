...
![How skill components map into agent context at startup and activation](https://mintcdn.com/langchain-5e9cc07a/-Q4wgirblfw7Ioet/oss/images/deepagents/skills-composition.svg?w=2500&fit=max&auto=format&n=-Q4wgirblfw7Ioet&q=85&s=ba4a6607e43da84db304e213bd40f6f0)
...
![How skills load in layers from metadata to instructions to resources](https://mintcdn.com/langchain-5e9cc07a/-Q4wgirblfw7Ioet/oss/images/deepagents/skills-progressive-disclosure.svg?w=2500&fit=max&auto=format&n=-Q4wgirblfw7Ioet&q=85&s=c2702db03976e5ee9add4492a379ad6e)
...
For CLI storage conventions, see [App data](https://docs.langchain.com/oss/javascript/deepagents/code/configuration#data-locations).
...
The agent can *read* scripts from any backend, but to *execute* them, the agent needs access to a shell, which only [sandbox backends](https://docs.langchain.com/oss/javascript/deepagents/sandboxes) provide.
...
**Solution**: The agent can read scripts from any backend, but running them requires a [sandbox backend](https://docs.langchain.com/oss/javascript/deepagents/sandboxes). See [Execute code with skills](#execute-code-with-skills).
